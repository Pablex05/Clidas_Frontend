...
class EditAnalisis extends React.Component{
    ...
    put =()=>{
        ...
        let url = Apiurl + "analisis/edit/"+id;
    ...
    delete =()=>{
        let id = this.props.match.params.id;
        let url = Apiurl + "analisis/delete/"+id;
        let datos = {
            "id": id
        }
    ...
    componentDidMount(){
        let id = this.props.match.params.id;
        let url = Apiurl + 'analisis/getById/'+id;
        console.log(url)
        axios.get(url)
            .then(response =>{
                this.setState({
        ...
        return(
            <React.Fragment>
                ...
                <div className="container">
                    <br/>
                    <h3 style={{color:"#067791FF"}} align="center">Editar Analisis</h3>
                </div>
                <div className="container">
